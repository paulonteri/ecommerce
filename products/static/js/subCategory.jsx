...
class SubCategory extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // categorySlug: subcategoryData.category__slug,
      categorySlug: "slug",
            ...
            <div className="uk-grid-medium uk-child-width-1-1" data-uk-grid>
              ...
              <div className="uk-text-center">
                <ul className="uk-breadcrumb uk-flex-center uk-margin-remove uk-text-capitalize">
                  ...
                  <li>
                    <a href={"/products/catalog/categories/" + categorySlug}>
                      {categoryTitle}
                    </a>
                  </li>
                  <li>
                                  ...
                                  return (
                                    <li key={brand.title}>
                                      <input
                                        ...
                                        type="checkbox"
                                        onClick={() =>
                                          this.handleCategorySelect(brand.title)
                                        }
                                      />
